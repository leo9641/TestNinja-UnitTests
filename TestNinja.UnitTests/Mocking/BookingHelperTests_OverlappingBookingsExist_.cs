...
{
    [TestFixture]
    public class BookingHelperTests_OverlappingBookingsExist_
    {
        ...
        public void SetUp()
        {
            ...
            _repository.Setup<IQueryable<Booking>>(x => x.GetActiveBookings(1)).Returns(new List<Booking>
            {
                _existingBooking
            }.AsQueryable());
        }
        ...
        [Test]
        public void BookingStartsInTheMiddleAOfAnExistingBookingButFinishesAfter_ReturnExistingBookingReference()
        {
            var result = BookingHelper.OverlappingBookingsExist(new Booking
            {
                Id = 1,
